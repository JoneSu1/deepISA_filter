...
Provides a clean, reusable entry point that wraps the full filters pipeline
without requiring CLI usage.

Example:
    from deepISA.filters.pipeline.api import run_pipeline
...
from deepISA.filters.pipeline import run_pipeline as _run_pipeline
