...
from deepISA.score.infer_tf_expr import get_expressed_tfs
...
@patch("deepISA.score.infer_tf_expr.get_data_resource")
@patch("deepISA.score.infer_tf_expr.quantify_bw")
@patch("deepISA.score.infer_tf_expr.estimate_noise_threshold")
